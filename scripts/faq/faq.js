$(function(){
  ...
  // $('.faq__accordion-2, .faq__accordion-3').css({"padding": "0px"});
  ...
  $(".faq__accordion-question").click(function(){
    ...
    if(!$(this).hasClass("currentBtn")){
      ...
      // $(".current").animate({"padding" : "0px"}, 300);

      // 次のコンテンツを展開
      $($(this).attr("href")).animate({"height": "50px"}, 300);
      // $($(this).attr("href")).animate({"padding": "14px"}, 300);
